...
- `languages/` (lang-01 through lang-09): Python, Java, Kotlin, Swift, Dart, TypeScript, JavaScript, Rust, Zig
- `process/` (proc-01 through proc-03): Documentation, git/version control, code review
